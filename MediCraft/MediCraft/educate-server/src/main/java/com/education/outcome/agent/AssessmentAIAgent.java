...
public class AssessmentAIAgent {
    ...
    public String generateEvaluation(String studentInfo, String behaviorData,
        ...
        String prompt = """
                你是一名专业的学习效果评估助手，请基于以下学生数据生成评估报告。
                注意：请根据学生的学习主题生成对应领域的知识点，不要生成无关领域的内容。
                ...
                【学习概况】
                根据学习路径的主题，简要总结学习时长、进度、资源使用情况。

                【知识点掌握度】
                直接输出JSON对象，键为与学习主题相关的知识点名称，值为0-100的掌握度分数。
                例如学习MySQL时输出：{"SQL基础语法":50,"数据库设计":40,"索引优化":30}
                如果没有具体知识点数据，请根据学习主题推断3-5个相关知识点并给出掌握度分数。
